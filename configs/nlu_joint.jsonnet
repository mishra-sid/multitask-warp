...
local hparams = L.hparams.get({
    ...
    weight_decay: 0,
    path: 'data/nlu_evaluation_data/all_scenarios'
});
local H = hparams;

{
    ...
    "dataset_reader": { 
     ...
     "readers": {
       [data_set]: {
        "type": "nlu",
        "path": 'data/nlu_evaluation_data/' + data_set,
    ...
    } for data_set in ['social', 'lists', 'audio', 'iot', 'cooking', 'play', 'alarm', 'datetime', 'takeaway', 'general', 'qa', 'transport', 'email', 'recommendation', 'calendar', 'music'] 
    }},
    ...
    "train_data_path":  {[data_set]: 'train' for data_set in ['social', 'lists', 'audio', 'iot', 'cooking', 'play', 'alarm', 'datetime', 'takeaway', 'general', 'qa', 'transport', 'email', 'recommendation', 'calendar', 'music'] },
    "validation_data_path": {[data_set]: 'validation' for data_set in ['social', 'lists', 'audio', 'iot', 'cooking', 'play', 'alarm', 'datetime', 'takeaway', 'general', 'qa', 'transport', 'email', 'recommendation', 'calendar', 'music'] },
