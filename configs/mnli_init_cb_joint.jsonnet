...
local hparams = L.hparams.get({
    ...
    patience: null,
    pooling_index: 1,
    pretrained_prompts: '.aim/t-mnli-cb-joint/best.th',
...

{
    ...
    "dataset_reader": {
        ...
        "readers": {
          [data_set]: {
            "type": "huggingface",
            "path": if data_set == 'mnli' then 'glue' else 'super_glue',
            "name": if H.cross_validation then (data_set + '_cross_validation_' + H.seed) else data_set,
    ...
    "validation_dataset_reader": self.dataset_reader.readers['cb'],

    "train_data_path": { [data_set]: H.train_set for data_set in data_sets},
